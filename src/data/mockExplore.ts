...
export const mockExplore: ExploreItem[] = [
  { id: "e1", destination: "Santorini, Greece", coverImage: "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=600&q=80", tag: "Instagrammable", tags: ["Instagrammable"], user: "sara_travels", likes: 342 },
  ...
  { id: "e4", destination: "Amalfi Coast, Italy", coverImage: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&q=80", tag: "Hidden Gems", tags: ["Hidden Gems"], user: "italyvibes", likes: 187 },
  ...
  { id: "e8", destination: "Faroe Islands", coverImage: "https://images.unsplash.com/photo-1501436513145-30f24e19fcc8?w=600&q=80", tag: "Hidden Gems", tags: ["Hidden Gems"], user: "nordic_paths", likes: 423 },
];

/** Colors and pixel dimensions for the Leaflet DivIcon markers built in `mapIcons.tsx`. */
export const MARKER_ICON_WHITE = "#ffffff";
export const COUNTRY_MARKER_COLOR = "#0284C7";
export const ACCENT_MARKER_COLOR = "#D97706";
export const VISITED_BORDER_COLOR = "#059669";

export const COUNTRY_MARKER_SIZE_PX = 40;
